...
<div class="p-3 text-left col-4 "id="listContainer">
        <ul class="list-group">
            <li class="list-group-item" onclick="showDiv($('#newPriorityForm'))">Create new priority</li>
            <li class="list-group-item" onclick="showDiv($('#newRoleForm'))">Create new role</li>
            <li class="list-group-item" onclick="showDiv($('#newUserForm'))">Create new user</li>
            <li class="list-group-item" onclick="showDiv($('#deleteUserForm'))">Delete user</li>
            <li class="list-group-item" onclick="showDiv($('#deletePriorityForm'))">Delete priority</li>
        </ul>
</div>
<div class="container">
    ...
    <form>
        <div class="form-group pt-2"  id="newUserForm">
            ...
            <select type="text" class="form-control w-50" id="gender" aria-describedby="TaskInput" required>
    ...
    <form>
        <div class="form-group pt-2" id="deleteUserForm">
            ...
            <select type="text" class="form-control w-50" id="userSelect" aria-describedby="TaskInput" required>
            </select> 
            <br>
    ...
    <form>
        <div class="form-group pt-2" id="deletePriorityForm">
            ...
            <label for="delPriority">Select priority</label>
            <select type="text" class="form-control w-50" id="delPriority" aria-describedby="TaskInput" required>
            </select> 
            <br>
